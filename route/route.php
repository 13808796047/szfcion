...
Route::group('wallet', function () {
    ...
    // 柜台
    Route::get('counter', 'wallet/counter');
    // 释放
    Route::any('release', 'wallet/release');
});
...
Route::group('fund', function () {
    // 基金首页
    Route::get('$', 'fund/index');
    // 充值
    Route::post('recharge', 'fund/recharge');
    // 公示
    Route::get('notice', 'fund/notice');
});
...
Route::group('boss', function () {
    ...
    // 欢迎
    Route::get('welcome', 'boss/welcome');
    // 加入
    Route::rule('join', 'boss/join', 'GET|POST');
    // 资料
    Route::rule('profile', 'boss/profile', 'GET|POST');
    // 搜索
    Route::post('search', 'boss/search');
});
...
Route::group('contract', function () {
    ...
    // 商品交割 - 详情
    Route::rule('transaction', 'contract/transaction', 'GET|POST');
    // 商品交割 - 行动
    Route::post('action', 'contract/action');
    // 商品交割 - 系统提示
    Route::post('system', 'contract/system');
    // 商品交割 - 审判
    Route::post('trial', 'contract/trial');
    // 代理商
...
Route::group('payment', function () {
    ...
    Route::get('index', 'payment/index');
    // 提交充值
    Route::post('recharge', 'payment/recharge');
    // 异步通知
    Route::post('notify/:channel', 'payment/notify');
    // 页面返回
    Route::get('callback', 'payment/callback');
    // 历史
    Route::post('history', 'payment/history');
});

// 提现接口
Route::group('withdraw', function () {
    // 提交
    Route::post('post', 'withdraw/post');
    // 历史
    Route::post('history', 'withdraw/history');
});

// 以太坊
Route::group('ethereum', function () {
    // 首页
    Route::get('index', 'ethereum/index');
});

// 日历
Route::group('calendar', function () {
    // 首页
    Route::get('$', 'calendar/index');
    Route::get('index', 'calendar/index');
    // 打卡
    Route::post('clock', 'calendar/clock');
    // 历史
    Route::post('history', 'calendar/history');
    // 按月统计
    Route::post('month', 'calendar/month');
});
